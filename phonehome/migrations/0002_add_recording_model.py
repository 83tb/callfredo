...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('phonehome_recording', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('call_sid', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('caller', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('recipient', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=240)),
        ))
        db.send_create_signal('phonehome', ['Recording'])


    def backwards(self, orm):
        # Deleting model 'Recording'
        db.delete_table('phonehome_recording')
