...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recording.fb_user_name'
        db.add_column('phonehome_recording', 'fb_user_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recording.fb_user_name'
        db.delete_column('phonehome_recording', 'fb_user_name')
